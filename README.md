...
The fine-tuned model is hosted on **[Hugging Face Hub](https://huggingface.co/Md-Talha017/bart-samsum)** (`Md-Talha017/bart-samsum`), enabling instant inference without local training.
